        ...
        <Layout page='compara'>
            <div className="flex flex-col gap-10 md:gap-0 animate-fade-down animate-once">
                ...
                <div className='flex flex-col justify-center md:flex md:justify-center md:items-center'>
                    <div className="md:flex md:flex-col md:justify-center md:items-start md:py-[70px]">
                        <h1 id={style.title}>Préstamos personales para <span id={style.word}>surfear</span> las emergencias</h1>
                        <div className="flex flex-col justify-center items-center p-2 lg:p-2 lg:flex-row lg:gap-4 w-full">
                            <Calculator
                            ...
                            />
                            <div className="max-lg:hidden md:w-[503px] md:h-[497px] lg:relative md:bottom-3">
                                <img
                                    src={wallet}
                                    alt="wallet"
                                />
                ...
                <div className="flex justify-center p-4 pt-[250px] md:pt-[150px]">
                    <div className="flex flex-row w-[1080px] h-[427px] rounded-[25px] relative" style={{ backgroundColor: colors.fdoMdo }}>
                        <div className="flex flex-col gap-4 sm:w-[640px] p-8 md:pt-16">
                            ...
                            <div className="flex flex-col gap-4 md:flex-col lg:flex-row md:gap-10">
                        ...
                        <div>
                            <img src={woman} alt="woman" className="w-[202px] sm:w-[300px] flex absolute bottom-[427px] right-[55px] md:w-[333px] lg:w-[444px] md:bottom-0 lg:left-[620px] transition animate-fade-down " />
                        </div>
                    </div>
                </div>

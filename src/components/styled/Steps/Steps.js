...
const AppSteps = () => {
    return (
        <div className="flex flex-col justify-center items-center gap-10 w-full p-8" id={styles.steps}>
            ...
            <div className="grid grid-cols-2 place-content-center lg:flex lg:flex-row lg:gap-5 gap-5 py-10">
                ...
                <div style={{ border: `4px solid ${colors.resalte1}` }} className={`w-[156px] h-[156px] md:w-[196px] md:h-[196px] bg-white rounded-[25px] flex flex-col justify-center items-center relative`}>
                    ...
                    <img src={regist} alt="image_regist" className="w-[72px] md:w-[90px] md:hover:animate-pulse md:hover:animate-once md:hover:animate-ease-in" />
                ...
                <div className="w-[156px] h-[156px] md:w-[196px] md:h-[196px] bg-white rounded-[25px] flex flex-col justify-center items-center relative">
                    ...
                    <img src={aut} alt="image_regist" className="w-[72px] md:w-[90px] md:hover:animate-pulse md:hover:animate-once md:hover:animate-ease-in" />
                ...
                <div className="w-[156px] h-[156px] md:w-[196px] md:h-[196px] bg-white rounded-[25px] flex flex-col justify-center items-center relative">
                    ...
                    <img src={docs} alt="image_regist" className="w-[72px] md:w-[90px] md:hover:animate-pulse md:hover:animate-once md:hover:animate-ease-in" />
                    <span style={{ fontFamily: 'Inter', fontWeight: 'normal' }} className="text-center text-[14px] md:text-[16px]">Sube tus <br />documentos</span>
                </div>

                <div
                    className="w-[156px] h-[156px] md:w-[196px] md:h-[196px] bg-white rounded-[25px] flex flex-col justify-center items-center relative">
                    <div
                        className="absolute right-[-3px] top-[-3px]">
                        <span
                            style={{ backgroundColor: colors.resalte1, fontFamily: 'Inter', fontWeight: 'bold', color: 'white' }}
                    ...
                    <img src={firma} alt="image_regist" className="w-[72px] md:w-[90px] md:hover:animate-pulse md:hover:animate-once md:hover:animate-ease-in" />
